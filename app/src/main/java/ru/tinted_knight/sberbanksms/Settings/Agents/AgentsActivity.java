...
public class AgentsActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor> {
...
//                Toast.makeText(AgentsActivity.this, text + " = " + String.valueOf(id), Toast.LENGTH_SHORT).show();
